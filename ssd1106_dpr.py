# MicroPython SSD1106 OLED enhanced driver, use diff-page-refresh accelerate, I2C and SPI interfaces
# https://github.com/emofalling/micropython-ssd1106_dpr
...
class SSD1106(framebuf.FrameBuffer):
  ...
  #         write_cmd(SET_COL_ADDR_L + 0)     # offset 2 pixels for 128x64 panel
  #         write_cmd(SET_COL_ADDR_H + 0)
  #         write_data(buffer[i*128:(i+1)*128])   # send one page display data
